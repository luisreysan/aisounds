...
$mp3 = $null
if ($hookData.status -eq 'completed') { $mp3 = 'C:\Users\luisr\Documents\ai_sounds\.aisounds\packs\wav-test\sounds\task_complete.mp3' }
elseif ($hookData.status -eq 'error' -or $hookData.status -eq 'aborted') { $mp3 = 'C:\Users\luisr\Documents\ai_sounds\.aisounds\packs\wav-test\sounds\task_failed.mp3' }
