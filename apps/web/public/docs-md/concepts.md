...
| **VS Code** | `.vscode/aisounds.json` + scripts in `.vscode/aisounds/` | `onChatResponseComplete`, `onChatRequestSent`, `onToolInvocation` (scripts; Copilot has no public auto-hooks yet) |
| **Windsurf / Aider** | — | Coming soon — use `--tool cursor` or `--tool claude-code` today |
...
npx @aisounds/cli@latest install retro-beeps --tool vscode
```
